    ...
    <div>
      ...
      <div className='container'>
        <div className='mt-5 mb-5'>
          <div style={{ border: "1px solid gray ", borderRadius: "30px" }}> <p className='ps-2 pt-2'>Home <i className="fa-solid fa-right-long"></i> Catalog <i className="fa-solid fa-right-long"></i> <span>{jay.name}</span></p></div>
        </div>
          ...
          <div className='pb-5'>
            <div className="row p-4 justify-content-around ">
              <div className="col-xl-5 pt-4 free1 pb-5">
                ...
                <h3 className='pb-3' style={{ color: "#a5c926" }}>{jay.price}</h3>
                <input type='number' style={{ width: "50px", borderRadius: "10px" }}></input> <button className='btn' style={{ backgroundColor: "#a5c926", borderRadius: "20px" }}>Add To Cart</button>
              </div>
              <div className="col-xl-5" style={{ width: "550px" }}>
                <img src={jay.url} className='img-fluied rounded-4 w-100' alt='' height="400px"></img>
              </div>
            </div>
